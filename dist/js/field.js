...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-live-update', __webpack_require__(4));
    Vue.component('detail-live-update', __webpack_require__(12));
    Vue.component('form-live-update', __webpack_require__(15));
});
